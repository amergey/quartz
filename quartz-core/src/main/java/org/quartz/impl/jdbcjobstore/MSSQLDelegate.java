...
public class MSSQLDelegate extends StdJDBCDelegate {
    ...
    /**
     * <p>
     * This method should be overridden by any delegate subclasses that need special
     * handling for BLOBs. The default implementation uses standard JDBC
     ...
     * @throws ClassNotFoundException if a class found during deserialization cannot
     *                                be found
    ...
    public List<TriggerKey> selectTriggerToAcquire(Connection conn, long noLaterThan, long noEarlierThan, int maxCount)
        ...
        try {
            ...
            // Try to give jdbc driver a hint to hopefully not pull over more than the few
            // rows we actually need.
            // Note: in some jdbc drivers, such as MySQL, you must set maxRows before
            // fetchSize, or you get exception!
